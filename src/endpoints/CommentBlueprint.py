...
def get_comments(chapter_number: int, page_number: int):
    ...
    try:
        ...
        comments: list[dict] = service.comment_service.get_comments(chapter_number, page_number, pagination)
...
def post_comment(chapter_number: int, page_number):
    try:
        ...
        service.comment_service.post_comment(chapter_number, page_number, comment)
